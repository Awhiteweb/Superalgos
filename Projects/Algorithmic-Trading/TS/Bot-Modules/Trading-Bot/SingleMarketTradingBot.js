exports.newAlgorithmicTradingBotModulesSingleMarketTradingBot = function (processIndex) {
    ...
    let session = TS.projects.algorithmicTrading.botModules.tradingSession.newAlgorithmicTradingBotModulesTradingSession(processIndex)
        ...
        try {
            ...
            function loop() {
                try {
                    ...
                    SA.logger.debug('single market  heart beat (line 64)')
                                        ...
                                        case TS.projects.foundations.globals.standardResponses.DEFAULT_OK_RESPONSE.result: {
                                            ...
                                            switch (TS.projects.foundations.globals.taskConstants.TASK_NODE.bot.processes[processIndex].referenceParent.config.framework.name) {
                                                case 'Low-Frequency-Trading-Process': {
                                                    processFramework = TS.projects.algorithmicTrading.botModules.tradingProcess.newAlgorithmicTradingBotModulesTradingProcess(processIndex);
                    ...
                    function loopControl(nextWaitTime) {
                        ...
                        SA.logger.debug('single market heart beat (line 653)')
                        ...
                        function onContinue() {
                            ...
                            switch (nextWaitTime) {
                                case 'Waiting for Session': {
                                    ...
                                    SA.logger.debug('single market heart beat (line 682)')
                                ...
                                case 'Normal': {
                                    ...
                                    SA.logger.debug('single market heart beat (line 724)')
                                ...
                                case 'Retry': {
                                    ...
                                    SA.logger.debug('single market heart beat (line 733)')
                                ...
                                case 'Sleep': {
                                    ...
                                    SA.logger.debug('single market heart beat (line 742)')
                                ...
                                case 'Coma': {
                                    ...
                                    SA.logger.debug('single market heart beat (line 751)')
